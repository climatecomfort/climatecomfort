...
model_temperature_mgcv<-gam(temperature_pmv~s(temperature_month)+s(temperature_mean)+s(humidity_month, k=5)+s(humidity_mean)+s(radiation_month)+s(radiation_mean)+s(wind_month)+question_dummy+s(id,bs="re"),family=ocat(R=7), weights=weight, data=sf_results_all,method="REML")
...
dev.off()
visreg(model_temperature_mgcv, xvar="temperature_month", gg=F, type="conditional", overlay=T, partial=T, rug=T, jitter=T, ylab="Response",top="points",ylab="Latent variable (breaks as PMV)",xlab="Monthly temperature (Celsius)")
abline(h=c(-1,0.46,1.62,3.6,4.58,5.56),col="red",lty=2) # usa os mesmos pontos de quebra indicados por summary(modelo_temperature_mgcv)
...
visreg(model_temperature_mgcv, xvar="humidity_month", gg=F, type="conditional", overlay=T, partial=T, rug=T, jitter=T, ylab="Response",top="points",ylab="Latent variable (breaks as PMV)",xlab="Monthly relative humidity (%)")
abline(h=c(-1,0.46,1.62,3.6,4.58,5.56),col="red",lty=2) # usa os mesmos pontos de quebra indicados por summary(modelo_temperature_mgcv)
...
visreg(model_temperature_mgcv, xvar="radiation_month", gg=F, type="conditional", overlay=T, partial=T, rug=T, jitter=T, ylab="Response",top="points",ylab="Latent variable (breaks as PMV)",xlab="Monthly surface solar radiation downwards (J/m2)")
abline(h=c(-1,0.46,1.62,3.6,4.58,5.56),col="red",lty=2) # usa os mesmos pontos de quebra indicados por summary(modelo_temperature_mgcv)
...
visreg(model_temperature_mgcv, xvar="wind_month", gg=F, type="conditional", overlay=T, partial=T, rug=T, jitter=T, ylab="Response",top="points",ylab="Latent variable (breaks as PMV)",xlab="Monthly wind speed (m/s)")
abline(h=c(-1,0.46,1.62,3.6,4.58,5.56),col="red",lty=2) # usa os mesmos pontos de quebra indicados por summary(modelo_temperature_mgcv)
...
january_mgcv_temperature_classes<-classify(x=january_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
february_mgcv_temperature_classes<-classify(x=february_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
march_mgcv_temperature_classes<-classify(x=march_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
april_mgcv_temperature_classes<-classify(x=april_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
may_mgcv_temperature_classes<-classify(x=may_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
june_mgcv_temperature_classes<-classify(x=june_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
july_mgcv_temperature_classes<-classify(x=july_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
august_mgcv_temperature_classes<-classify(x=august_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
september_mgcv_temperature_classes<-classify(x=september_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
october_mgcv_temperature_classes<-classify(x=october_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
november_mgcv_temperature_classes<-classify(x=november_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
december_mgcv_temperature_classes<-classify(x=december_mgcv_temperature_clamp, rcl=c(-2,-1,0.46,1.62,3.6,4.58,5.56,6),include.lowest=TRUE)
...
library(khroma)
YlOrBr <- color("YlOrBr")
plot(ppd_mgcv_temperature_mean, col=YlOrBr(100),background="grey55")
sbar(d=2000,xy=c(-165,-65),divs=2,type="bar",below="km",ticks=T,cex=.6)
north(xy=c(-160,-45),type=2,cex=.7,label=NULL)
